...
namespace Zymion\SeoFriendlyImages\Block\Product;
...
class ImageFactory extends \Magento\Catalog\Block\Product\ImageFactory
{
    ...
    private function getLabel(Product $product, string $imageType): string
    {
        ...
        if ($this->seoFriendlyImagesHelper->overwriteAlt()
            ...
            if (empty($label)) {
                $label = $this->seoFriendlyImagesHelper->getSeoFriendlyAltText($product);
            } else {
                $label = $this->seoFriendlyImagesHelper->replaceVariablesInFileName($label, $product);
            }
        }
        if (empty($label)) {
    ...
    public function create(Product $product, string $imageId, array $attributes = null): ImageBlock
    {
        ...
        if ($originalFilePath === null || $originalFilePath === 'no_selection') {
            ...
            $newFile = $this->seoFriendlyImagesHelper->getSeoFriendlyImageName($product, $originalFilePath);
