...
class ProductTemplateListCommand extends \Symfony\Component\Console\Command\Command
{
    /**
    ...
    /**
     * ProductTemplateListCommand constructor.
     *
    ...
    {
        $this->setName('ecwhim-seo:seotemplates:product-template:list');
        $this->setDescription('Displays the list of Product SEO Templates');
