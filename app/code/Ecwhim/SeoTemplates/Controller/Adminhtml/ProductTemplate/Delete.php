...
class Delete extends \Ecwhim\SeoTemplates\Controller\Adminhtml\ProductTemplate implements HttpPostActionInterface
{
    /**
    ...
    public function execute()
    {
        ...
        if ($templateId) {
            try {
                ...
                return $resultRedirect->setPath('*/*/edit', [ProductTemplateInterface::TEMPLATE_ID => $templateId]);
            } catch (\Exception $e) {
