...
class Edit extends \Ecwhim\SeoTemplates\Controller\Adminhtml\CategoryTemplate implements HttpGetActionInterface
{
    const MENU_ID = 'Ecwhim_SeoTemplates::seo_templates_category_template';
    ...
    public function execute()
    {
        ...
        if ($templateId) {
            try {
                ...
                $resultPage->getConfig()->getTitle()->prepend(__('Category SEO Templates'));
                $resultPage->getConfig()->getTitle()->prepend(__('Edit Category Template "%1"', $template->getName()));
