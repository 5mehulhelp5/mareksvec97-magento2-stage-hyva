...
class ValidateBeforeSavingObserver implements \Magento\Framework\Event\ObserverInterface
{
    ...
    /**
     * @var \Ecwhim\SeoTemplates\Model\Source\ProductTemplate\Type
     */
     ...
     * @param \Ecwhim\SeoTemplates\Model\Source\ProductTemplate\Type $productTemplateType
     */
    public function __construct(
        \Ecwhim\SeoTemplates\Model\Source\Scope $scope,
        \Magento\Store\Model\ResourceModel\Store $storeResource,
        \Ecwhim\SeoTemplates\Model\Source\ProductTemplate\Type $productTemplateType
    ) {
        $this->scope               = $scope;
     ...
     * @throws \Magento\Framework\Exception\ValidatorException
     */
    protected function validateScope(\Ecwhim\SeoTemplates\Api\Data\ProductTemplateInterface $template): bool
    {
     ...
     * @throws \Magento\Framework\Exception\ValidatorException
     */
    protected function validateStoreIds(\Ecwhim\SeoTemplates\Api\Data\ProductTemplateInterface $template): bool
    {
     ...
     * @throws \Magento\Framework\Exception\ValidatorException
     */
    protected function validateType(\Ecwhim\SeoTemplates\Api\Data\ProductTemplateInterface $template): bool
    {
        ...
        if (!in_array($type, array_keys($this->productTemplateType->getTypes()))) {
            throw new \Magento\Framework\Exception\ValidatorException(
