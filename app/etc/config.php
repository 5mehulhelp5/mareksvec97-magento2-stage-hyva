...
return [
    'modules' => [
        ...
        'Amasty_AsyncOperations' => 1,
        'Amasty_AutomaticRelatedProductsSubscriptionPackage' => 1,
        'Amasty_AiBlogProContentGenerator' => 1,
        'Amasty_Blog' => 1,
        'Hyva_Theme' => 1,
        ...
        'Amasty_Customform' => 1,
        'Amasty_CustomFormsProSubscriptionPackage' => 1,
        'Amasty_MailchimpCore' => 1,
        ...
        'Apptrian_Minify' => 0,
        'Apptrian_PinterestPixel' => 0,
        'Apptrian_Subcategories' => 1,
        'Benabee_ProductManagerConnector' => 1,
        'BigConnect_Badges' => 1,
        'BigConnect_CategoryDescription' => 1,
        'Magecomp_Quickcontact' => 0,
        'BigConnect_Cookies' => 0,
        'BigConnect_Core' => 1,
        'BigConnect_CustomOptionPlus' => 1,
        'BigConnect_FmePricecalcPatch' => 1,
        'BigConnect_HyvaStarter' => 1,
        'BigConnect_Inspiration' => 1,
        ...
        'Ecwhim_SeoTemplates' => 1,
        'FME_Pricecalculator' => 1,
        'FME_HyvaPricecalculator' => 1,
        'Geissweb_Euvat' => 1,
        'Magewirephp_Magewire' => 1,
        'Hyva_Checkout' => 1,
        'Hyva_CheckoutStripe' => 1,
        'Amasty_BlogHyva' => 1,
        'Hyva_Email' => 1,
        'Hyva_GeisswebEuvat' => 1,
        'Hyva_GeisswebEuvatCheckout' => 1,
        ...
        'BigConnect_ContactForms' => 0,
        'Magefan_AdminUserGuide' => 0,
        'Magefan_Community' => 0,
        'Magefan_RocketJavaScript' => 0,
        'Magegadgets_SvgWebImages' => 0,
        'Magehq_Core' => 1,
        'Magehq_CustomOrderNumber' => 1,
        'Mageplaza_Core' => 1,
        ...
        'Magiccart_Lookbook' => 0,
        'Magmodules_AlternateHreflang' => 1,
        'Maisondunet_CookieConsent' => 1,
        'Metalio_HeaderLinks' => 1,
        'Metalio_Settings' => 1,
        'MetaloPro_DisablePayment' => 1,
        'MetaloPro_GateCategoryControl' => 1,
        'MetaloPro_ProductBlacklist' => 1,
        'Mirasvit_Core' => 1,
        'Mirasvit_Feed' => 1,
        'Mirasvit_Report' => 1,
        'Mollie_Payment' => 0,
        'Mollie_HyvaCompatibility' => 0,
        'N1site_CategoryImage' => 1,
        'N1site_Checkout' => 1,
        'N1site_Menu' => 0,
        'Namespace_TabsInfo' => 0,
        'OlegKoval_RegenerateUrlRewrites' => 1,
        'BigConnect_OuteredgeRewrite' => 0,
        'PayPal_Braintree' => 1,
        ...
        'Swissup_AddressAutocomplete' => 0,
        'Swissup_AddressFieldManager' => 1,
        'Swissup_AddressValidation' => 0,
        ...
        'Swissup_SubscribeAtCheckout' => 0,
        'Swissup_Swiper' => 0,
        'Swissup_Taxvat' => 1,
        'Swissup_Tippyjs' => 1,
        'Trustedshops_EasyIntegration' => 1,
        'Ulmod_CanonicalUrl' => 1,
        'Wouyang_DisableCsp' => 1,
        'Zymion_SeoFriendlyImages' => 0
    ]
];
